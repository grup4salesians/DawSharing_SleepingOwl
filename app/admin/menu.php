...
Admin::menu()->label('Menu with subitems')->icon('fa-book')->items(function (){
    ...
    Admin::menu()->url('/')->label('Ruta')->uses('\AdminController@getIndex');
    Admin::menu()->url('/')->label('Viatge')->uses('\AdminController@getIndex');
    Admin::menu()->url('/')->label('Model')->uses('\AdminController@getIndex');
});
